package com.deolan.logbook;

import com.deolan.logbook.config.ApplicationProperties;
import com.deolan.logbook.config.DefaultProfileUtil;
...
public class LogbookApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(LogbookApp.class);

    private final Environment env;

    public LogbookApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LogbookApp.class);
